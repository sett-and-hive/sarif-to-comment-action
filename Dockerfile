...
# We update to 2.93.0 (May 2026) to fix CVE-2026-48501 (auth header leak in attestation
# commands) and ensure the binary was compiled with a modern Go runtime (fixing stdlib CVEs).
